...
int main()
{
    ...
    while (zrodlo.y < 0 || zrodlo.x < 0 || zrodlo.y >= w || zrodlo.x >= k || mapa[index(zrodlo)] == '@')
    {
    ...
    do
    {
        ...
        cin >> cel.y >> cel.x;
        while (cel.y < 0 || cel.x < 0 || cel.y >= w || cel.x >= k || mapa[index(cel)] == '@')
        {
            cout << "podaj poprawne wspolrzedne" << endl;
            cin >> cel.y >> cel.x;
        }
        ...
        if (G[celid] == kosztmax)
        {
            ...
            cout << endl
                 << "czy wytyczyc inna trase? (T/N)" << endl;
            cin >> odp;
        }
        ...
        else
        {
            ...
            zrodloid = celid;
            cout << endl
                 << "czy wytyczyc kolejna trase? (T/N)" << endl;
            cin >> odp;
        }
